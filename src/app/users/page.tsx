                  ...
                  <div key={u.id} className="p-4 space-y-2.5">
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        ...
                        <span className="text-xs font-mono font-semibold text-slate-500">{u.userId}</span>
                    ...
                    <div className="flex items-center justify-end gap-2 pt-1 border-t border-slate-50">
                      <button
                        ...
                        className="px-2.5 py-1.5 rounded-lg text-xs font-medium text-indigo-700 bg-indigo-50 hover:bg-indigo-100 transition flex items-center gap-1 cursor-pointer"
                      >
